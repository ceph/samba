...
{
	int result = -1;
	DEBUG(10, ("[CEPH] readlink(%p, %s, %p, %lu)\n", handle, path, buf, bufsiz));
...
{
	DEBUG(10, ("[CEPH] getxattr(%p, %s, %s, %p, %lu)\n", handle, path, name, value, size));
...
{
	DEBUG(10, ("[CEPH] fgetxattr(%p, %p, %s, %p, %lu)\n", handle, fsp, name, value, size));
...
{
	DEBUG(10, ("[CEPH] listxattr(%p, %s, %p, %lu)\n", handle, path, list, size));
...
{
	DEBUG(10, ("[CEPH] llistxattr(%p, %s, %p, %lu)\n", handle, path, list, size));
...
{
	DEBUG(10, ("[CEPH] flistxattr(%p, %p, %s, %lu)\n", handle, fsp, list, size));
...
{
	DEBUG(10, ("[CEPH] setxattr(%p, %s, %s, %p, %lu, %d)\n", handle, path, name, value, size, flags));
...
{
	DEBUG(10, ("[CEPH] fsetxattr(%p, %p, %s, %p, %lu, %d)\n", handle, fsp, name, value, size, flags));
